...
const CreateVisitReportDialog = ({ open, onClose, refresh }: any) => {
  ...
  padding: 90px;
        ...
        .cvrd-status input[value="Positive"]:checked + label {
          background: #f0fdf4; border-color: #22c55e; color: #15803d;
        }
        .cvrd-status input[value="Negative"]:checked + label {
          background: #fff1f2; border-color: #f43f5e; color: #be123c;
        }
                ...
                <div className="cvrd-box" onClick={(e) => e.stopPropagation()}>
                    ...
                    <div className="cvrd-header">
                        <div>
                            ...
                            <div className="cvrd-h-title">New Visit Report</div>
                            <div className="cvrd-h-sub">Fill all details after visiting the clinic.</div>
                        </div>
                    ...
                    <div className="cvrd-body">
                        ...
                        <div className="cvrd-sec">
                            ...
                            <div className="cvrd-g2">
                                <div className="cvrd-field">
                                    ...
                                    <input className="cvrd-input" name="doctorName" placeholder="Dr. Sharma" onChange={handleChange} />
                                </div>
                                <div className="cvrd-field">
                                    <label className="cvrd-label">SFDC ID</label>
                                    <input className="cvrd-input" name="sfdcId" placeholder="SFD-0001" onChange={handleChange} />
                                </div>
                                <div className="cvrd-field">
                                    <label className="cvrd-label">Doctor Mobile</label>
                                    <input
                                        className="cvrd-input"
                                        name="doctorMobile"
                                ...
                                <div className="cvrd-field cvrd-span2">
                                    ...
                                    <input
                                        ...
                                        onChange={(e) =>
                                            setFormData({
                                                ...formData,
                                                doctorSpecialization: e.target.value.split(',').map((s) => s.trim())
                                            })
                                        }
                                    />
                                </div>
                                <div className="cvrd-field">
                                    ...
                                    <input className="cvrd-input" name="clinicName" placeholder="Apollo Clinic" onChange={handleChange} />
                                </div>
                                <div className="cvrd-field cvrd-span2">
                                    <label className="cvrd-label">Clinic Address</label>
                                    <textarea className="cvrd-input" name="clinicAddress" placeholder="Street, Area, City, PIN..." onChange={handleChange} />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="cvrd-sec">
                                    ...
                                    <div className="cvrd-radio-group" style={{ flexDirection: 'column' }}>
                                        {['Individual Clinic', 'Multispeciality Clinic', 'Hospital OPD', 'Diagnostic Center'].map(v => (
                                            <div className="cvrd-radio" key={v}>
                                                <input type="radio" name="clinicType" id={`ct-${v}`} value={v} onChange={handleChange} />
                                ...
                                <div className="cvrd-field">
                                    ...
                                    <div className="cvrd-radio-group" style={{ flexDirection: 'column', marginBottom: 14 }}>
                                        {['Commercial Zone', 'Residential Zone'].map(v => (
                                            <div className="cvrd-radio" key={v}>
                                                <input type="radio" name="localityType" id={`lt-${v}`} value={v} onChange={handleChange} />
                                    ...
                                    <div className="cvrd-radio-group" style={{ marginTop: 6 }}>
                                        {['Yes', 'No'].map(v => (
                                            <div className="cvrd-radio" key={v}>
                                                <input type="radio" name="clinicOpenDuringVisit" id={`co-${v}`} value={v} onChange={handleChange} />
                            ...
                            <div className="cvrd-field" style={{ maxWidth: 200 }}>
                                ...
                                <input className="cvrd-input" name="clinicExistenceYears" type="number" placeholder="5" onChange={handleChange} />
                            </div>
                        </div>
                        ...
                        <div className="cvrd-sec">
                            ...
                            <div className="cvrd-g2" style={{ marginBottom: 16 }}>
                                <div className="cvrd-field">
                                    ...
                                    <input className="cvrd-input" name="approxArea" type="number" placeholder="500" onChange={handleChange} />
                                </div>
                                <div className="cvrd-field">
                                    ...
                                    <div className="cvrd-radio-group">
                                        {['Furnished', 'Unfurnished'].map(v => (
                                            <div className="cvrd-radio" key={v}>
                                                <input type="radio" name="furnishedStatus" id={`fs-${v}`} value={v} onChange={handleChange} />
                                ...
                                <div className="cvrd-field">
                                    ...
                                    <div className="cvrd-radio-group">
                                        {[['Good', '😊'], ['Average', '😐'], ['Bad', '😟']].map(([v, e]) => (
                                            <div className="cvrd-radio" key={v}>
                                                <input type="radio" name="ambience" id={`amb-${v}`} value={v} onChange={handleChange} />
                                ...
                                <div className="cvrd-field">
                                    ...
                                    <div className="cvrd-radio-group">
                                        {['Owned', 'Rented', 'Other'].map(v => (
                                            <div className="cvrd-radio" key={v}>
                                                <input type="radio" name="ownership" id={`own-${v}`} value={v} onChange={handleChange} />
                        ...
                        <div className="cvrd-sec">
                            ...
                            <div className="cvrd-g2" style={{ marginBottom: 16 }}>
                                <div className="cvrd-field">
                                    ...
                                    <input className="cvrd-input" name="visitingTiming" placeholder="e.g. 9am – 1pm" onChange={handleChange} />
                                </div>
                                <div className="cvrd-field">
                                    <label className="cvrd-label">Patients Seen (approx)</label>
                                    <input className="cvrd-input" name="patientsSeen" type="number" placeholder="30" onChange={handleChange} />
                                </div>
                            </div>
                                ...
                                <div className="cvrd-days">
                                    {days.map((day, i) => (
                                        <div className="cvrd-day" key={day}>
                                            <input type="checkbox" id={`day-${day}`} value={fullDays[i]} onChange={handleVisitingDays} />
                            ...
                            <div className="cvrd-field" style={{ maxWidth: 220 }}>
                                ...
                                <input className="cvrd-input" name="consultationFees" type="number" placeholder="500" onChange={handleChange} />
                            </div>
                        </div>
                        ...
                        <div className="cvrd-sec">
                            ...
                            <div className="cvrd-status-group" style={{ marginBottom: 16 }}>
                                <div className="cvrd-status">
                                    <input type="radio" name="finalStatus" id="stat-pos" value="Positive" onChange={handleChange} />
                                    <label htmlFor="stat-pos"><span className="em">✅</span>Positive</label>
                                </div>
                                <div className="cvrd-status">
                                    <input type="radio" name="finalStatus" id="stat-neg" value="Negative" onChange={handleChange} />
                                    <label htmlFor="stat-neg"><span className="em">❌</span>Negative</label>
                                </div>
                            </div>
                            <div className="cvrd-field">
                                <label className="cvrd-label">Remarks</label>
                                <textarea className="cvrd-input" name="remarks" placeholder="Any additional notes or observations..." rows={3} onChange={handleChange} />
                            </div>
                        </div>

                        {/* Section 6 — Visiting Person */}
                        <div className="cvrd-sec">
                            <div className="cvrd-sec-head">
                            ...
                            <div className="cvrd-g2">
                                <div className="cvrd-field">
                                    ...
                                    <input className="cvrd-input" name="visitingPersonName" placeholder="Rahul Verma" onChange={handleChange} />
                                </div>
                                <div className="cvrd-field">
                                    <label className="cvrd-label">Employee ID</label>
                                    <input className="cvrd-input" name="employeeId" placeholder="EMP-2024" onChange={handleChange} />
                                </div>
                                <div className="cvrd-field">
                                    <label className="cvrd-label">Visit Date</label>
                                    <input type="date" className="cvrd-input" name="visitDate" onChange={handleChange} />
                                </div>
                                <div className="cvrd-field">
                                    <label className="cvrd-label">Visit Time</label>
                                    <input type="time" className="cvrd-input" name="visitTime" onChange={handleChange} />
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="cvrd-footer">
                        ...
                        <button className="cvrd-btn-submit" onClick={handleSubmit}>Submit Report →</button>
                    </div>
